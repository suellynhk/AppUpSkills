...
function MicrolearningFlexibilityCollaborator() {
            ...
            <View style={styles.insideBox}  >
                <ScrollView>
                    <View style={styles.alignBox}>
                        ...
                        <Text style={styles.labelText}> Flexibilidade </Text> 
                        <Text style={styles.microlearningText}>
                           
                        </Text> 

                        <Video
                        source={require('../../../assets/flexibilidade.mp4')}
                        rate={1.0}
...
export default MicrolearningFlexibilityCollaborator;
