...
function PeopleManagement() {
    ...
    function handleNavigateToCompletedQuestionnaire() {      
       navigate('CompletedQuestionnaire');
    };
            ...
            <View style={styles.container}>
                ...
                <View style={styles.insideBox}>
                    ...
                    <View style= {styles.bottomButton}>
                        ...
                        <RectButton onPress={handleNavigateToCompletedQuestionnaire} style={styles.recButton}>
