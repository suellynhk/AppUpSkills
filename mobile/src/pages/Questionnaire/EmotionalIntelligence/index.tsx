...
function EmotionalIntelligence() {
    ...
    function handleNavigateToComplexProblemsSolving() {      
        navigate('ComplexProblemsSolving');
     } 
            ...
            <View style={styles.container}>
                ...
                <View style={styles.insideBox}>
                    ...
                    <View style= {styles.bottomButton}>
                        <BorderlessButton onPress={handleNavigateToComplexProblemsSolving} style={styles.button}>
                            <Image source={leftIcon} style={styles.buttonImg}/>
                        </BorderlessButton>

                        <BorderlessButton onPress={handleNavigateToJudgmentDecisionMaking} style={styles.button}>
